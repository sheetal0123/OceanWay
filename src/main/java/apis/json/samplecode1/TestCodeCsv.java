...
public class TestCodeCsv {
	...
	public static Service convertLinkedHashMaptoPojoObject(LinkedHashMap<String, LinkedHashMap<String, String>> bigMap){
		...
		for(LinkedHashMap<String, String> lhm : bigMap.values()){
			...
			for(Entry<String, String> entry : lhm.entrySet()){
				...
				switch(key){
					...
					case "Address#AddressGeo#Lat": addressgeo.setLattitude(value);break;
	...
	public static void main(String[] args) throws IOException {
		//read input csv
		LinkedHashMap<String, LinkedHashMap<String, String>> bigLinkedHashMap = readCompleteCSVFile(new File(System.getProperty("user.dir")+"\\src\\main\\java\\apis\\json\\samplecode1\\inputdata.csv"));
		
		
		//convert into java object
		Service serivce = TestCodeCsv.convertLinkedHashMaptoPojoObject(bigLinkedHashMap);
		
			
		//create json file
		String file = ".\\src\\main\\java\\apis\\json\\samplecode1\\empusingcsv.json";
		FileWriter fw = null;
		...
		System.out.println("Json file 'empusingcsv.json' created succesfully from 'inputdata.csv'");
	}
