...
-WithConst obj1: initially obj1 set to null
-new WithConst(10, 20) : allocate physical memory to object on the Heap
-WithConst obj1 = new WithConst(10, 20) : now obj1 reference variable actually refer to  WithConst class object on the Heap
