package api_json.gson.csv_to_json;
...
public class TestCreateJsonUsingCSVData {
	...
	public static void main(String[] args) throws IOException {
		//read input csv
		String csvFilePath = ".\\src\\main\\java\\api_json\\gson\\csv_to_json\\inputdata.csv";
		...
		ServicePlaceholderPojo serivce = TestCreateJsonUsingCSVData.convertLinkedHashMaptoPojoObject(bigLinkedHashMap);
		
			
		//create json file
		String file = ".\\src\\main\\java\\api_json\\gson\\csv_to_json\\empusingcsv.json";
		FileWriter fw = null;
