package api_json.jackson.dynamic_json_to_obj;
...
public class ProductJsonNodeTestClass {
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException {
		...
		// Set 1:
		String mobileJsonPath = "./src/main/java/api_json/jackson/dynamic_json_to_obj/mobile.json";
		...
		// Set 2:
		String shoesJsonPath = "./src/main/java/api_json/jackson/dynamic_json_to_obj/shoes.json";
