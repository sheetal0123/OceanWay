 ...
 * If functional interface method require only one parameter then we can use following lam3 style also
 * If method dont have any argument then we can use :    Type obj = () -> implementation; 
